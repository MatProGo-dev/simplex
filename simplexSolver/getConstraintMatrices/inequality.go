...
// 			var newLHS symbolic.Expression
// 			var newRHS symbolic.Expression

// 			newLHS = constraint.Left().(symbolic.ScalarExpression)
...
// 			scalarLHSs = append(scalarLHSs, newLHS.(symbolic.ScalarExpression))
// 			scalarRHSs = append(scalarRHSs, newRHS.(symbolic.ScalarExpression))
...
// 			vectorLHSs = append(vectorLHSs, newLHS.(symbolic.VectorExpression))
// 			vectorRHSs = append(vectorRHSs, newRHS.(symbolic.VectorExpression))
// 		default:
// 			panic(
